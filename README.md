...
This first step is to add a Raspberry PI between my midi keyboard and usb speakers, and use an open source sw synthesizer to make it sound like a piano, without extra digital step such as a DAW or analog step such as a soundcard or audio interface in between.
